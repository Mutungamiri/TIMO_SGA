...
# layout_slider = [
#                     [sg.Slider(range=(50, 5000), default_value=50, resolution=50, orientation='h', key='ITER')]
#                   ]
...
window = sg.Window('Genetic algorithm', layout, resizable=True,scaling=.9 ) #scaling=.9
...
while True:
    ...
    if event == 'Wyjdź' or event == sg.WIN_CLOSED:
        ...
        # app.funkcjaDlaApp.obj = (funkcja_obj)
